...
class PostOfficeToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_post_office_to_different_loc)
        var listview: ListView =findViewById(R.id.PostToDifferentLoc)
