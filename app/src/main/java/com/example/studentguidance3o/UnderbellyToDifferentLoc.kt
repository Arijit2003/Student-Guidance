...
class UnderbellyToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_underbelly_to_different_loc)
        var listview:ListView=findViewById(R.id.underbellyToDifferentLoc)
