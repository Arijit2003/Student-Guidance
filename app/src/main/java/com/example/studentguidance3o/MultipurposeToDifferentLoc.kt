...
class MultipurposeToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_multipurpose_to_different_loc)
        var listview: ListView =findViewById(R.id.MultipurposeToDifferentLoc)
