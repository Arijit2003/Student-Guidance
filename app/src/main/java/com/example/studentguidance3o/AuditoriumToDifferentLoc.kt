...
class AuditoriumToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_auditorium_to_different_loc)
        var listview: ListView =findViewById(R.id.AuditoriumToDifferentLoc)
        ...
        arrayList.add(Location(R.drawable.underbelly,"Visa Mart",dest))
        arrayList.add(Location(R.drawable.auditorium,"Multipurpose Hall",dest))
