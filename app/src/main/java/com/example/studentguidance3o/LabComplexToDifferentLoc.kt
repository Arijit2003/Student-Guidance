...
class LabComplexToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lab_complex_to_different_loc)
        var listview: ListView =findViewById(R.id.LabComplexToDifferentLoc)
