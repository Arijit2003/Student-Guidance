...
class GirlsHostelToDiffLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_girls_hostel_to_diff_loc)
        val listview:ListView=findViewById(R.id.ghToDifferentLoc)
        ...
        val arrayAdapter=MyArrayAdapter(this,R.layout.source_page_one_sample,arrayList)
