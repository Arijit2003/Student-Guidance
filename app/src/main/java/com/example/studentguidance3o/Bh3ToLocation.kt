...
class Bh3ToLocation : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bh3_to_location)
        ...
        DestinationName.add(Location(R.drawable.boys_hostel2,"Boys Hostel 2",dest))
