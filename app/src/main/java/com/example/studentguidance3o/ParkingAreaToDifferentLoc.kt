...
class ParkingAreaToDifferentLoc : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_parking_area_to_different_loc)
        var listview: ListView =findViewById(R.id.ParkingToDifferentLoc)
